...
The first problem was loading. Every frame is a separate image, and the browser only fetches each one at the moment the animation first reaches it — so the opening loop flashed white wherever a frame hadn't arrived yet.<br><br>
I did two things to fix it:<br>
